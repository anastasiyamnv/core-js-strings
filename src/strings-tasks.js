...
function removeFirstOccurrences(str, value) {
  ...
  if (firstocc === -1) return str;
  return str.slice(0, firstocc) + str.slice(firstocc + value.length);
}
...
function removeLastOccurrences(str, value) {
  ...
  if (lastocc === -1) return str;
  return str.slice(0, lastocc) + str.slice(lastocc + value.length);
}
